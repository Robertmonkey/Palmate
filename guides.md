...
```json
{
  ...
  "steps": [
    ...
    },
    {
      ...
      "detail": "Enter nearby dungeons for their guaranteed alpha fight and two chest rewards, then rotate to a fresh instance once the exit closes to keep parts flowing.【palwiki-dungeons†L1-L9】【palwiki-ancient-civilization-parts†L9-L18】",
      "targets": [
        {
          "kind": "item",
          "id": "ancient-civilization-part",
